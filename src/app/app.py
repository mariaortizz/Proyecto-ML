...
import pandas as pd
from models_funciones import extraccion_cluster, extraccion_escalado, extraccion_modelos\
    , aplicar_escalado, transf_tipo_inmueble, aplicar_modelo
...
def predict():
    if request.method == 'POST':
        ...
        return render_template("predict.html", pecio_predd = precio[0].round(2))
    else:
